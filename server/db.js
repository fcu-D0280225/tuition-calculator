...
export async function initSchema() {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS care_growth (
      ...
      created_at  DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
      PRIMARY KEY (id),
      INDEX idx_care_growth_student (tenant_id, student_id, record_date)
    ) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `)
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS care_temperature (
      ...
      note        VARCHAR(255)   NOT NULL DEFAULT '',
      PRIMARY KEY (id),
      INDEX idx_care_temp_student (tenant_id, student_id, measured_at)
    ) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `)
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS care_medications (
      ...
      created_at    DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
      PRIMARY KEY (id),
      INDEX idx_care_med_student_date (tenant_id, student_id, med_date)
    ) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
  `)
}
